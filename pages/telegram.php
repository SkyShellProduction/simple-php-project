<div class="content">
    ...
    <form action="./tools/tg.php" class="form form__tg" method="POST" enctype="multipart/form-data">
        <input type="text" name="subject" class="input" placeholder="Введите тему сообщения" required>
